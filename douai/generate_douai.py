...
BOOK_MAP = {
    ...
    'Jgs':   ('judges',           'Judges'),
    'Ru':    ('ruth',             'Ruth'),
    '1Sam':  ('1samuel',          '1 Kings'),
    '2Sam':  ('2samuel',          '2 Kings'),
    '1Kings':('1kings',           '3 Kings'),
    '2Kings':('2kings',           '4 Kings'),
    '1Chr':  ('1chronicles',      '1 Paralipomenon'),
    '2Chr':  ('2chronicles',      '2 Paralipomenon'),
    'Ezr':   ('ezra',             '1 Esdras'),
    'Neh':   ('nehemiah',         '2 Esdras'),
    'Tb':    ('tobit',            'Tobias'),
    'Jdt':   ('judith',           'Judith'),
    'Est':   ('esther',           'Esther'),
    '1Mc':   ('1maccabees',       '1 Machabees'),
    '2Mc':   ('2maccabees',       '2 Machabees'),
    'Jb':    ('job',              'Job'),
    'Ps':    ('psalms',           'Psalms'),
